...
<head>
  ...
  <title>Message Sent - HostMeerkat</title>

  <meta name="author" content="HostMeerkat.co.uk">
  <meta name="description" content="Your message has been sent successfully to HostMeerkat. We will reply shortly.">
  <link rel="canonical" href="https://hostmeerkat.co.uk/message.php" />

  <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700;800;900&display=swap" rel="stylesheet">
  
  <meta property="og:type" content="website">
  <meta property="og:locale" content="en_GB">
  <meta property="og:description" content="Your message has been sent successfully to HostMeerkat. We will reply shortly.">
  <meta name="theme-color" content="#2b2f32">
  <meta property="og:site_name" content="HostMeerkat">
  <meta property="og:url" content="https://hostmeerkat.co.uk/message.php">
  <meta property="og:title" content="Message Sent - HostMeerkat">
  <meta property="og:image" content="https://hostmeerkat.co.uk/assets/images/og_image.png">
  
  <meta name="twitter:card" content="summary_large_image">
  <meta name="twitter:url" content="https://hostmeerkat.co.uk/message.php">
  <meta name="twitter:title" content="Message Sent - HostMeerkat">
  <meta name="twitter:description" content="Your message has been sent successfully to HostMeerkat. We will reply shortly.">
  ...
  <script type="application/ld+json">
  {
    ...
    "@type": "ContactPage",
    "name": "Message Sent - HostMeerkat",
    "url": "https://hostmeerkat.co.uk/message.php",
    "description": "Your message has been sent successfully to HostMeerkat. We will reply shortly."
  }
  </script>
</head>
...
<body>
  ...
  <section class="contact-hero" style="min-height: 70vh; display: flex; align-items: center;">
    <div class="container text-center fade-up">
      <div class="badge-custom">
        <span class="badge-dot"></span> Success
      </div>
      <h1 class="hero-heading">Message <span class="heading-gradient">Sent</span></h1>
      <p class="hero-intro">
        We have received your enquiry and our team will get back to you as soon as possible.
      </p>

      <div id="formAlert" class="form-alert form-alert-success is-visible" role="alert" style="max-width: 600px; margin: 2rem auto;">
        Thank you! Your message has been sent successfully. We will reply shortly.
      </div>

      <div class="d-flex justify-content-center gap-3 mt-4 flex-wrap">
        <a href="index.html" class="btn-touch">
          <i class="fa-solid fa-house"></i> Back to Home
        </a>
        <a href="contact.php" class="btn-touch" style="background: transparent; border: 1px solid rgba(255,255,255,0.2);">
          <i class="fa-solid fa-paper-plane"></i> Send Another Message
        </a>
      </div>
    </div>
  </section>
